...
export const AppYesCallAlert = (msg, onOkCallback, onCancelCallback,title = APP_NAME) => {
    setTimeout(() => {
        Alert.alert(
            title,
            msg,
...
export const AppTwoButtonBackAlert = (msg,  negitiveBtnTitle, positiveBtnTitle, positiveCallback,  title = APP_NAME) => {
    setTimeout(() => {
        Alert.alert(
            title,
            msg,
            [
                // {text: 'Ask me later', onPress: () => console.log('Ask me later pressed')},
                {
                    text: negitiveBtnTitle,
                    onPress: () => console.log('Cancel Pressed'),
                    style: 'cancel',
                },
                {
                    text: positiveBtnTitle, onPress: () => { positiveCallback() }
                },
            ],
            { cancelable: false },
        );
